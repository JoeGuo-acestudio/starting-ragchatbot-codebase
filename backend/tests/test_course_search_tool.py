...
class TestCourseSearchTool:
    ...
    def test_execute_with_query_only(self, course_search_tool, mock_vector_store, sample_search_results):
    ...
    def test_execute_with_course_name_filter(self, course_search_tool, mock_vector_store, sample_search_results):
    ...
    def test_execute_with_lesson_number_filter(self, course_search_tool, mock_vector_store, sample_search_results):
    ...
    def test_execute_with_search_error(self, course_search_tool, mock_vector_store, error_search_results):
    ...
    def test_execute_with_empty_results(self, course_search_tool, mock_vector_store, empty_search_results):
    ...
    def test_execute_with_empty_results_and_course_filter(self, course_search_tool, mock_vector_store, empty_search_results):
    ...
    def test_execute_with_empty_results_and_lesson_filter(self, course_search_tool, mock_vector_store, empty_search_results):
    ...
    def test_execute_with_empty_results_and_both_filters(self, course_search_tool, mock_vector_store, empty_search_results):
        """Test execute with empty results and both filters"""
        mock_vector_store.search.return_value = empty_search_results
        
        result = course_search_tool.execute("test query", course_name="AI Fundamentals", lesson_number=1)
        
        assert result == "No relevant content found in course 'AI Fundamentals' in lesson 1."

    def test_format_results_with_lesson_links(self, course_search_tool, mock_vector_store):
        ...
        assert '<a href="https://example.com/lesson1"' in course_search_tool.last_sources[0]
        assert '<a href="https://example.com/lesson2"' in course_search_tool.last_sources[1]

    def test_format_results_without_lesson_links(self, course_search_tool, mock_vector_store):
    ...
    def test_format_results_with_unknown_course(self, course_search_tool, mock_vector_store):
    ...
    def test_last_sources_tracking(self, course_search_tool, mock_vector_store, sample_search_results):
