...
class TestSearchResults:
    ...
    def test_inequality(self):
        ...
        results2 = SearchResults(
            documents=["doc2"], metadata=[{"key": "value"}], distances=[0.1]
        )
    ...
    def test_realistic_course_data(self):
        ...
        results = SearchResults(
            ...
            metadata=[
                ...
                {"course_title": "Deep Learning", "lesson_number": 3, "chunk_index": 5},
            ],
            distances=[0.12, 0.34],
        )
    ...
    def test_chroma_results_missing_keys(self):
        ...
        chroma_results = {"metadatas": [[{"course": "test"}]], "distances": [[0.1]]}
